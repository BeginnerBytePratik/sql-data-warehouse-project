...
BEGIN
        ...
        SELECT
            ...
            CASE 
                WHEN sls_sales IS NULL OR sls_sales <= 0  
                     OR TRY_CAST(sls_sales AS FLOAT) != TRY_CAST(sls_quantity AS FLOAT) * ABS(TRY_CAST(sls_price AS FLOAT))
            ...
            CASE
                ...
                ELSE TRY_CAST(sls_price AS FLOAT)
            END AS sls_price
    ...
    END TRY
        ...
        PRINT '-------------------------------------------------';
        PRINT 'Please check the source data and try again.';
        PRINT '=================================================';
